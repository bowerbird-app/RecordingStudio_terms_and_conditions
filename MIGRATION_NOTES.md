...
No schema change. The Admin Terms hub no longer shows **New** or **All versions**. The actions are the live Terms page, the live Privacy Policy page, **Edit Terms**, and **Edit Privacy Policy**. Those page links are secondary. Hub cards are **Terms and conditions** and **Privacy Policy**. The count is large, and **users agreed** sits under it in smaller text. The versions screen is the table only, live rows first. `/recording_studio_terms_and_conditions/admin/terms` redirects to that screen. Who agreed searches name or email.
