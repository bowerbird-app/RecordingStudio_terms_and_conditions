...
- Gemspec: `recording_studio ~> 4.2`, `flat_pack >= 0.1.195`, `recording_studio_accessible ~> 0.8`, `recording_studio_admin ~> 2.0`, `recording_studio_publishable ~> 0.3`, `recording_studio_user >= 0.12.1`
- Dummy GitHub tags: Recording Studio `v4.2.0`, Accessible `v0.9.1`, Attachable `v0.5.1`, Publishable `v0.3.1`, Admin `v2.0.2`, Users `v0.12.1`, Root Switchable `v0.5.0`, FlatPack `v0.1.195`
