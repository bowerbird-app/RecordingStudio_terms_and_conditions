...
- Dummy opts in to `require_scroll_to_end`. Agree stays enabled while the live copy is collapsed, then waits for the end of the copy once it is open. Missing IntersectionObserver still leaves Agree enabled
