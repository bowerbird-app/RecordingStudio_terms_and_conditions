...
- Admin hub title is **Terms and Conditions**. The versions screen is **Old versions** (table heading matches). Receipts are **Agree stats**, with the table headed **Users**.
