...
- Agree no longer shows the on-page “Terms updated” Flatpack Alert or the “You already agreed…” paragraph. Re-accept keeps the flash “We've updated our Terms and Conditions”, the calendar date subtitle, and **Agree again**. Checkbox spacing uses `my-3` (top and bottom margin) instead of `py-5`.
- Requires FlatPack `>= 0.1.195` (dummy GitHub tag `v0.1.195`) for theme-primary checkboxes.
...
- Pin FlatPack `>= 0.1.195` and rebuild host Tailwind. Re-accept flash copy is now “We've updated our Terms and Conditions” (button stays **Agree again**).
