...
Bump to **0.6.0**. Set `config.app_name` if you want a fixed product name. When it is blank, the gem uses `RecordingStudioSiteSettings.name_for` if that method exists. Site Settings is optional. No schema change.
