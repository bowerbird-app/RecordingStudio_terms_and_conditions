...
module RecordingStudioTermsAndConditions
  module Generators
    # Generator to install RecordingStudioTermsAndConditions migrations into the host application.
    #
    # Usage:
    #   rails generate recording_studio_terms_and_conditions:migrations
    #
    # Options:
    ...
    class MigrationsGenerator < Rails::Generators::Base
      ...
      desc "Copy RecordingStudioTermsAndConditions migrations to your application"
      ...
      def copy_migrations
        ...
        unless File.directory?(migrations_dir)
          say "No migrations found in RecordingStudioTermsAndConditions engine.", :yellow
          return
        end
