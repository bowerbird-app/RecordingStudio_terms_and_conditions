  ...
  class KindUniqueness
    class << self
      ...
      def call(*args, **kwargs)
        ...
        recordable.kind_scope_recording = payload[:recording] || payload["recording"]
        recordable.kind_scope_root_recording = payload[:root_recording] || payload["root_recording"]
      end
    end
  end
end
